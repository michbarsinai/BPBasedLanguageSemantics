...
import static bp.state.unittest.ts.TSState.COLD;
import static bp.state.unittest.ts.TSState.NOTBAD;
...
public class TSMain implements BApplication {
	...
	static public void main(String arg[]) {
		try {
			BProgram.startBApplication(TSMain.class, "bp.state.unittest");
